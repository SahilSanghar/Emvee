...
import HvacSlide from '../../data/Hvac';

const Slide = () => {
    return (
        <div className='relative' id="home">
            <Carousel className="w-full overflow-hidden -mt-[200px]" opts={{ loop: true, speed: 500, delay: 3000 }}>
                <CarouselContent>
                    {HvacSlide.map((item, index) => (
                        <CarouselItem className="relative" key={index}>
                            <img src={item.imgSrc} alt={`Example ${index + 1}`} className="w-full h-[95vh] object-cover" />
