  ...
  return (
    (<div
      ...
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        ...
        <p
          className="text-white opacity-60 text-sm md:text-base max-w-sm">
        ...
        {data.map((item, index) => (
          <div key={index} className="flex justify-start pt-10 md:pt-40 md:gap-10">
            <div
              ...
              <div
                className="h-10 absolute left-3 md:left-3 w-10 rounded-full bg-[#2C2C2C] flex items-center justify-center">
                <div
                  className="h-4 w-4 rounded-full bg-[#171717] p-2" />
              </div>
              <h3
